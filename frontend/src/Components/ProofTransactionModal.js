...
const ProofTransactionModal = ({setshowTransactionModal,resetTransactionFields,selectedCustomer,TransactionType,Amount,setTransactionType,SetAmount,Remarks,SetRemarks,handleTransactionSave}) => {
  return (
      <div
          style={{
            position: "fixed",
...
export default ProofTransactionModal