...
const DGTransactionModal = ({setshowTransactionModal,resetTransactionFields,selectedCustomer,Amount,SetAmount,Weight,Remarks,SetRemarks,handleTransactionSave}) => {
  return (
      <div
          style={{
            position: "fixed",
...
export default DGTransactionModal